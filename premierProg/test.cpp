...
string element = "sun_x";
//const char* new_pos = "100";
...
static void receive_msg(string e, string n)
{
  element = e;
  //new_pos = n.c_str();
}
...
int main(int argc, char *argv[])
{
  ...
  // string c2 = "100";
  // map<string,string> m;
  // m.insert(pair<string,string>(c1,c2));
  //
  // receive_msg(m.begin()->first, m.begin()->second);
  gtk_init(&argc, &argv);
  GtkWidget *window;
